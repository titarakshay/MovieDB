				...
				<div className="content-block">
					...
					<div className="content-details">
						...
						<div className="text-secondary">
							...
							{contentDetail.production_countries.map(
								(countries, i) => (
			...
			<div className="pt-5">
				...
				<div className="pl-5 pt-3">
					...
					<div className="pb-3">
						...
						<p className="text-secondary">
							{contentDetail?.original_language}
						</p>
					</div>
					<div className="pb-3">
						<h3 className="cast-name">Budget</h3>
						<p className="text-secondary">
							{contentDetail?.budget > 0
								? contentDetail?.budget
								: "-"}
						</p>
					</div>
					<div className="pb-3">
						...
						<p className="text-secondary">
							{contentDetail?.revenue > 0
								? contentDetail?.revenue
								: "-"}
						</p>
					</div>
					<div className="pb-3">
